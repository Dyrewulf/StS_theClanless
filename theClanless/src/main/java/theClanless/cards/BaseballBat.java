...
public class BaseballBat extends AbstractDynamicCard {
    ...
    public static final String ID = theClanlessMod.makeID("BaseballBat"); // DELETE THIS ONE.
    public static final String IMG = makeCardPath("BaseballBat.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public BaseballBat() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
