...
public class BrassKnuckles extends AbstractDynamicCard {
    ...
    public static final String ID = theClanlessMod.makeID("BrassKnuckles"); // DELETE THIS ONE.
    public static final String IMG = makeCardPath("BrassKnuckles.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public BrassKnuckles() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
