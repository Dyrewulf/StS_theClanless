...
public class DefaultSecondMagicNumberSkill extends AbstractDynamicCard {
    ...
    public static final String ID = theClanlessMod.makeID(DefaultSecondMagicNumberSkill.class.getSimpleName());
    ...
    public DefaultSecondMagicNumberSkill() {
        ...
        clanlessSecondMagicNumber = baseClanlessSecondMagicNumber = POISON;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new ApplyPowerAction(m, p, new PoisonPower(m, p, this.clanlessSecondMagicNumber), this.clanlessSecondMagicNumber));
