...
public class UndeadStrength extends AbstractDynamicCard {
    ...
    public static final String ID = theClanlessMod.makeID("UndeadStrength"); // DELETE THIS ONE.
    public static final String IMG = makeCardPath("UndeadStrength.png");// "public static final String IMG = makeCardPath("${NAME}.png");
    ...
    public UndeadStrength() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
