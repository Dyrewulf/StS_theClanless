...
@SpireInitializer
public class theClanlessMod implements
        EditCardsSubscriber,
    ...
    public static Properties theClanlessDefaultSettings = new Properties();
    public static final String ENABLE_PLACEHOLDER_SETTINGS = "enablePlaceholder";
    public static boolean enablePlaceholder = true; // The boolean we'll be setting on/off (true/false)

    //This is for the in-game mod settings panel.
    private static final String MODNAME = "The Clanless";
    private static final String AUTHOR = "Dyrewulf"; // And pretty soon - You!
    private static final String DESCRIPTION = "A fledgling vampire faces the eternal struggle that is the Spire.";
    
    // =============== INPUT TEXTURE LOCATION =================
    
    // Colors (RGB)
    // Character Color
    public static final Color CLANLESS_RED = CardHelper.getColor(160.0f, 20.0f, 20.0f);
    ...
    private static final String IMAGES512 = "theClanlessResources/images/512/";
    private static final String IMAGES1024 = "theClanlessResources/images/1024/";

    // Card backgrounds - The actual rectangular card.
    private static final String ATTACK_CLANLESS_RED = IMAGES512 + "bg_attack_clanless_red.png";
    private static final String SKILL_CLANLESS_RED = IMAGES512 + "bg_skill_clanless_red.png";
    private static final String POWER_CLANLESS_RED = IMAGES512 + "bg_power_clanless_red.png";

    private static final String ATTACK_CELERITY = IMAGES512 + "bg_attack_celerity.png";
    private static final String SKILL_CELERITY = IMAGES512 + "bg_skill_celerity.png";
    private static final String POWER_CELERITY = IMAGES512 + "bg_power_celerity.png";

    private static final String ATTACK_FORTITUDE = IMAGES512 + "bg_attack_fortitude.png";
    private static final String SKILL_FORTITUDE = IMAGES512 + "bg_skill_fortitude.png";
    private static final String POWER_FORTITUDE = IMAGES512 + "bg_power_fortitude.png";

    private static final String ATTACK_POTENCE = IMAGES512 + "bg_attack_potence.png";
    private static final String SKILL_POTENCE = IMAGES512 + "bg_skill_potence.png";
    private static final String POWER_POTENCE = IMAGES512 + "bg_power_potence.png";
    
    private static final String ENERGY_RED_TEAR = IMAGES512 + "red_teardrop.png";
    private static final String CARD_RED_TEAR = IMAGES512 + "card_small_teardrop.png";
    
    private static final String ATTACK_CLANLESS_RED_PORTRAIT = IMAGES1024 + "bg_attack_clanless_red.png";
    private static final String SKILL_CLANLESS_RED_PORTRAIT = IMAGES1024 + "bg_skill_clanless_red.png";
    private static final String POWER_CLANLESS_RED_PORTRAIT = IMAGES1024 + "bg_power_clanless_red.png";
    private static final String ENERGY_RED_TEAR_PORTRAIT = IMAGES1024 + "card_teardrop.png";

    private static final String ATTACK_CELERITY_PORTRAIT = IMAGES1024 + "bg_attack_celerity.png";
    private static final String SKILL_CELERITY_PORTRAIT = IMAGES1024 + "bg_skill_celerity.png";
    private static final String POWER_CELERITY_PORTRAIT = IMAGES1024 + "bg_power_celerity.png";

    private static final String ATTACK_FORTITUDE_PORTRAIT = IMAGES1024 + "bg_attack_fortitude.png";
    private static final String SKILL_FORTITUDE_PORTRAIT = IMAGES1024 + "bg_skill_fortitude.png";
    private static final String POWER_FORTITUDE_PORTRAIT = IMAGES1024 + "bg_power_fortitude.png";

    private static final String ATTACK_POTENCE_PORTRAIT = IMAGES1024 + "bg_attack_potence.png";
    private static final String SKILL_POTENCE_PORTRAIT = IMAGES1024 + "bg_skill_potence.png";
    ...
    public theClanlessMod() {
      ...
      */
        ...
        logger.info("Creating the color " + TheClanless.Enums.COLOR_CLANLESSRED.toString());
        
        BaseMod.addColor(TheClanless.Enums.COLOR_CLANLESSRED, CLANLESS_RED, CLANLESS_RED, CLANLESS_RED,
                CLANLESS_RED, CLANLESS_RED, CLANLESS_RED, CLANLESS_RED,
                ATTACK_CLANLESS_RED, SKILL_CLANLESS_RED, POWER_CLANLESS_RED, ENERGY_RED_TEAR,
                ATTACK_CLANLESS_RED_PORTRAIT, SKILL_CLANLESS_RED_PORTRAIT, POWER_CLANLESS_RED_PORTRAIT,
                ENERGY_RED_TEAR_PORTRAIT, CARD_RED_TEAR);

        BaseMod.addColor(TheClanless.Enums.CELERITY, CLANLESS_RED, CLANLESS_RED, CLANLESS_RED,
                CLANLESS_RED, CLANLESS_RED, CLANLESS_RED, CLANLESS_RED,
                ATTACK_CELERITY, SKILL_CELERITY, POWER_CELERITY, ENERGY_RED_TEAR,
                ATTACK_CELERITY_PORTRAIT, SKILL_CELERITY_PORTRAIT, POWER_CELERITY_PORTRAIT,
                ENERGY_RED_TEAR_PORTRAIT, CARD_RED_TEAR);

        BaseMod.addColor(TheClanless.Enums.POTENCE, CLANLESS_RED, CLANLESS_RED, CLANLESS_RED,
                CLANLESS_RED, CLANLESS_RED, CLANLESS_RED, CLANLESS_RED,
                ATTACK_POTENCE, SKILL_POTENCE, POWER_POTENCE, ENERGY_RED_TEAR,
                ATTACK_POTENCE_PORTRAIT, SKILL_POTENCE_PORTRAIT, POWER_POTENCE_PORTRAIT,
                ENERGY_RED_TEAR_PORTRAIT, CARD_RED_TEAR);

        BaseMod.addColor(TheClanless.Enums.FORTITUDE, CLANLESS_RED, CLANLESS_RED, CLANLESS_RED,
                CLANLESS_RED, CLANLESS_RED, CLANLESS_RED, CLANLESS_RED,
                ATTACK_FORTITUDE, SKILL_FORTITUDE, POWER_FORTITUDE, ENERGY_RED_TEAR,
                ATTACK_FORTITUDE_PORTRAIT, SKILL_FORTITUDE_PORTRAIT, POWER_FORTITUDE_PORTRAIT,
                ENERGY_RED_TEAR_PORTRAIT, CARD_RED_TEAR);
        ...
        theClanlessDefaultSettings.setProperty(ENABLE_PLACEHOLDER_SETTINGS, "FALSE"); // This is the default setting. It's actually set...
        try {
            SpireConfig config = new SpireConfig("clanlessMod", "theClanlessConfig", theClanlessDefaultSettings); // ...right here
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = theClanlessMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = theClanlessMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = theClanlessMod.class.getPackage().getName(); // STILL NO EDIT ZONE
    ...
    public static void initialize() {
        logger.info("========================= Initializing Clanless Mod. Hi. =========================");
        theClanlessMod thismod = new theClanlessMod();
        logger.info("========================= /Clanless Mod Initialized. Hello World./ =========================");
    }
    ...
    public void receivePostInitialize() {
        ...
        ModLabeledToggleButton enableNormalsButton = new ModLabeledToggleButton("This is the text which goes next to the checkbox.",
            ...
            try {
                ...
                SpireConfig config = new SpireConfig("defaultMod", "theDefaultConfig", theClanlessDefaultSettings);
        ...
        AddEventParams eventParams = new AddEventParams.Builder(IdentityCrisisEvent.ID, IdentityCrisisEvent.class) // for this specific event
            ...
            .playerClass(TheClanless.Enums.THE_CLANLESS) // Character specific event
            .create();
